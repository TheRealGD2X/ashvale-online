...
const CAMPS := {"ashvale": [
	...
	"saltmere": [
		{"kind": "tide_crab", "lv": [40, 41], "n": 8, "at": Vector2(62, 8), "r": 15.0},
		{"kind": "tide_crab", "lv": [40, 41], "n": 6, "at": Vector2(60, 60), "r": 15.0},
		{"kind": "puglin_wrecker", "lv": [40, 41], "n": 5, "at": Vector2(54, 88), "r": 17.0},
		{"kind": "puglin_wrecker", "lv": [41, 42], "n": 3, "at": Vector2(30, 100), "r": 13.0},
		{"kind": "drowned_sailor", "lv": [42, 44], "n": 8, "at": Vector2(72, 80), "r": 15.0},
		{"kind": "sea_serpent", "lv": [42, 44], "n": 6, "at": Vector2(80, -10), "r": 15.0},
		{"kind": "tidecaller", "lv": [43, 45], "n": 6, "at": Vector2(86, -38), "r": 13.0},
		{"kind": "snapjaw", "lv": [45, 45], "n": 1, "at": Vector2(66, -58), "r": 0.5, "elite": true},
		{"kind": "gutbag", "lv": [46, 46], "n": 1, "at": Vector2(68, 96), "r": 0.5, "elite": true},
		{"kind": "wolf", "lv": [40, 41], "n": 5, "at": Vector2(-80, -30), "r": 16.0},
	],
	"drowned_hold": [
	...
	"emberreach": [
		{"kind": "magma_worm", "lv": [46, 47], "n": 8, "at": Vector2(-14, -4), "r": 14.0},
		{"kind": "magma_worm", "lv": [46, 48], "n": 6, "at": Vector2(-46, 16), "r": 13.0},
		{"kind": "cinder_fiend", "lv": [47, 48], "n": 7, "at": Vector2(-80, -62), "r": 15.0},
		{"kind": "obsidian_guard", "lv": [47, 49], "n": 6, "at": Vector2(20, -40), "r": 16.0},
		{"kind": "cinderhide", "lv": [48, 50], "n": 8, "at": Vector2(-50, 70), "r": 16.0},
		{"kind": "ember_drake", "lv": [48, 50], "n": 6, "at": Vector2(90, 4), "r": 16.0},
		{"kind": "slag_elemental", "lv": [49, 51], "n": 6, "at": Vector2(-92, 30), "r": 15.0},
	...
	"palereach": [
		{"kind": "frost_wolf", "lv": [52, 53], "n": 10, "at": Vector2(30, 50), "r": 18.0},
		{"kind": "snow_bear", "lv": [52, 54], "n": 6, "at": Vector2(-26, 80), "r": 16.0},
		{"kind": "mountain_ram", "lv": [52, 54], "n": 6, "at": Vector2(96, 20), "r": 16.0},
		{"kind": "rimeborn", "lv": [53, 54], "n": 8, "at": Vector2(-40, -50), "r": 16.0},
		{"kind": "ice_golem", "lv": [54, 55], "n": 6, "at": Vector2(-56, 30), "r": 14.0},
		{"kind": "snowmane", "lv": [54, 56], "n": 8, "at": Vector2(8, -88), "r": 15.0},
		{"kind": "rime_witch", "lv": [55, 56], "n": 6, "at": Vector2(-80, 4), "r": 13.0},
	...
	"scar": [
		{"kind": "void_imp", "lv": [57, 58], "n": 10, "at": Vector2(-64, 16), "r": 17.0},
		{"kind": "soul_wraith", "lv": [57, 58], "n": 8, "at": Vector2(-84, -40), "r": 16.0},
		{"kind": "voidforged", "lv": [58, 59], "n": 6, "at": Vector2(-6, -40), "r": 15.0},
		{"kind": "vaals_chosen", "lv": [58, 60], "n": 8, "at": Vector2(84, 30), "r": 16.0},
		{"kind": "void_horror", "lv": [59, 60], "n": 5, "at": Vector2(72, -40), "r": 14.0},
		{"kind": "voidcaller", "lv": [59, 60], "n": 6, "at": Vector2(-44, -72), "r": 13.0},
		{"kind": "doomherald_kess", "lv": [61, 61], "n": 1, "at": Vector2(84, -80), "r": 0.5, "elite": true},
	],
	"sanctum": [
		{"kind": "sanctum_knight", "lv": [60, 60], "n": 3, "at": Vector2(0, 76), "r": 5.0},
		{"kind": "ashen_colossus", "lv": [62, 62], "n": 1, "at": Vector2(0, 42), "r": 0.5, "boss": true},
		{"kind": "sanctum_voidcaller", "lv": [60, 61], "n": 3, "at": Vector2(-34, 24), "r": 5.0},
		{"kind": "the_archivist", "lv": [62, 62], "n": 1, "at": Vector2(-58, -8), "r": 0.5, "boss": true},
