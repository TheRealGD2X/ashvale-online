...
const PLACES := {
	...
	# ---- levels 40–60
	"gullhaven": "gullhaven's on the coast, east of varn down the salt road", "maren": "maren holt, the harbormaster, on gullhaven's square",
	"ione": "sister ione is on gullhaven square, west side", "cask": "cask runs the salted gull in gullhaven, west of the square. repairs too",
	"tobiah": "old tobiah's up at the lighthouse on gull point, north of town", "lighthouse": "lighthouse is on gull point, take the road north-east out of gullhaven",
	"crab": "tide crabs are on the kelp flats, east of gullhaven by the water", "claw": "claws drop off the tide crabs on the kelp flats",
	...
	"ysolde": "warden ysolde is in forgehold on the west side of the square", "dain": "dain's the quartermaster in forgehold, sells food and repairs",
	"worm": "magma worms are on the lava lake shores west of forgehold", "fiend": "cinder fiends are at the ashworks, north-west past the lava lake",
	"imp": "imps? fiends at the ashworks in emberreach, or void imps out in the scar", "ashworks": "ashworks is north-west in emberreach, past the lava lake",
	"smelter": "the smelter is in the ashworks furnace door. group it", "obsidian": "obsidian guardians are on the black glass fields north of the lake",
	"drake": "drakes nest on the roost, east of forgehold", "roost": "the roost is east of forgehold", "pyreclaw": "pyreclaw is at the top of the roost. big group, lots of fire",
	"cinderhide": "cinderhide are in the charred wood, south-west of forgehold", "slag": "slag elementals are in the slag fields, far west of emberreach",
	"deep": "molten deep is north of forgehold under the black glass fields", "tharn": "forgemaster tharn is the second boss in the molten deep",
	"wintermere": "wintermere is through the frostgate, west of emberreach", "aldric": "aldric the huntmaster, wintermere by the fire",
	"sigrun": "mother sigrun, wintermere square, east side", "eir": "runescribe eir is in wintermere, north side of the fire", "tove": "tove runs the lodge in wintermere, sells food",
	"whitefang": "old whitefang's deep in the wolfrun, south. get a group", "rimeborn": "rimeborn are up at the barrows, west of wintermere",
	"golem": "ice golems walk the frozen lake", "barrow": "barrows are west of wintermere, standing stones and mounds", "rune": "rune shards are round the standing stones at the barrows",
	"snowmane": "snowmane lycans camp in the northern pass", "witch": "rime witches are at the foot of the frostspire, far west", "frostspire": "frostspire is the ice spire in the far west of the pale reach",
	"hrimgar": "hrimgar's the frozen king, end of frostspire halls", "ram": "rams are on the east slopes of the pale reach, they don't fight back much",
