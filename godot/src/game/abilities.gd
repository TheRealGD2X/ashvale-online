...
const LIST := {
	...
	"prayer_of_healing": {"name": "Prayer of Healing", "cls": "cleric", "level": 26, "school": "holy", "cost": 25, "cd": 6.0, "helpful": true,
	...
	"radiance": {"name": "Radiance", "cls": "cleric", "level": 40, "school": "holy", "cost": 18, "helpful": true, "cd": 8.0,
		"kind": "hot", "range": Rules.SPELL_RANGE, "total": [90, 22.0], "dur": 12.0, "tick": 2.0, "anim": "Spell_Simple_Shoot", "fx": "renewal",
