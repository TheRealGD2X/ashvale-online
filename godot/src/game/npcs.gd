...
"name": "Sergeant Maddox", "title": "Warrior Trainer", "at": [14.0, 4.0], "face": 250, "sex": "m", "look": "warrior", "hair": "Hair_Buzzed", "skin": 4,
	...
	"bram": {"zone": "hollow", "name": "Bram", "title": "Camp Cook", "at": [-1.5, 32.5], "face": 120, "sex": "m", "look": "peasant", "hair": "Hair_Buzzed", "beard": "Hair_MuttonChops", "hair_color": 3,
		"greet": "Stew's on. Stew's always on. Don't ask what's in it.", "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "inn": true, "anim": "Idle_Talking"},
	...
	"hux": {"zone": "hollow", "name": "Quartermaster Hux", "title": "Guild Quartermaster", "at": [3.0, 19.0], "face": 170, "sex": "m", "look": "noble", "hair": "Hair_SlickBack", "hair_color": 1,
		"greet": "Everything in this camp belongs to the guild. Including, technically, the air. Breathe carefully.", "market": true, "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "repair": true, "anim": "Idle_FoldArms"},
	# ---- Mirewood Landing
	...
	"dodd": {"zone": "mirewood", "name": "Ferryman Dodd", "title": "Ferryman", "at": [-31.0, 21.0], "face": 230, "sex": "m", "look": "peasant", "hair": "Hair_Long", "beard": "Hair_Beard", "hair_color": 5,
		"greet": "Ferry's not running. Water's too black. Buy something while you wait.", "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "inn": true, "market": true, "anim": "Idle"},
	...
	"fenn": {"zone": "mirewood", "name": "Corporal Fenn", "title": "Mirewood Wardens", "at": [-34.0, 36.0], "face": 200, "sex": "m", "look": "warrior", "hair": "Hair_Buzzed", "hair_color": 1,
		"greet": "Corporal Fenn. I hold the bridge. Well — I'm meant to.", "repair": true, "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "anim": "Idle_Shield"},
	...
	"pell": {"zone": "ashslopes", "name": "Stonemason Pell", "title": "Stonemason", "at": [16.0, 38.0], "face": 120, "sex": "m", "look": "peasant", "hair": "Hair_Buzzed", "beard": "Hair_MuttonChops", "hair_color": 2, "skin": 3,
		"greet": "Every statue on this mountain has a name. I know most of them. Some of them owe me money.", "repair": true, "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "inn": true, "market": true, "anim": "Idle"},
	...
	"oda": {"zone": "highlands", "name": "Quartermaster Oda", "title": "Highland Watch", "at": [-24.0, 32.0], "face": 200, "sex": "f", "look": "noble", "hair": "Hair_Bob", "hair_color": 0,
		"greet": "Sign here. And here. And here — no, the other here.", "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "repair": true, "inn": true, "market": true, "anim": "Idle_FoldArms"},
	...
	"durn": {"zone": "varn", "name": "Smith Durn", "title": "Blacksmith", "at": [18.0, 66.0], "face": 250, "sex": "m", "look": "peasant", "hair": "Hair_Buzzed", "beard": "Hair_Beard", "hair_color": 1, "skin": 4,
		"greet": "Horseshoes, swords, the odd saddle buckle. I make what keeps people alive.", "vendor": ["hearty_stew", "warm_meal", "spring_water", "mountain_water", "minor_healing_potion", "healing_potion_mid"], "repair": true, "inn": true, "market": true, "anim": "Idle_FoldArms"},
